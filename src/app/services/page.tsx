      ...
      <main className="flex-grow">
        ...
        <section className="py-16 max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-white p-8 rounded-3xl border border-brand-canvas shadow-sm hover:shadow-md transition-shadow">
        ...
        <section className="py-20 bg-white border-t border-brand-canvas">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col gap-12">
              ...
              <div className="bg-brand-canvas rounded-3xl p-8 md:p-12 border border-brand-slate/10 shadow-sm">
