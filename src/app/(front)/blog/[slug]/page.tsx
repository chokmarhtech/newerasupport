    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-1 pt-12 pb-20">
        <div className="max-w-4xl mx-auto px-6 space-y-8">
          ...
          <div className="bg-brand-navy text-white rounded-3xl p-8 flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 shrink-0">
              ...
              >
                <PhoneCall className="w-3.5 h-3.5 text-brand-mint" /> 07950 850970
              </Link>
            </div>
          </div>
        </div>
