      ...
      <main className="flex-grow">
        ...
        <section className="relative overflow-hidden py-20 lg:py-28 bg-white border-b border-brand-canvas">
          <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6 border-t border-brand-canvas mt-4 text-xs font-semibold">
                <div className="flex items-center gap-3 bg-brand-canvas p-3 rounded-2xl border border-brand-slate/10">
                  ...
                  <div>
                    ...
                    <span className="block text-brand-navy font-bold text-xs">88 Kingsway, London, WC2B 6SR</span>
                  </div>
                </div>
            ...
            <div className="lg:col-span-5 relative flex items-center justify-center">
              ...
              <div className="absolute -top-6 -left-4 bg-white p-4 rounded-3xl shadow-xl border border-brand-canvas flex items-center gap-3 animate-bounce duration-1000">
              ...
              <div className="absolute -bottom-6 -right-4 bg-brand-mint text-brand-navy p-5 rounded-3xl shadow-xl flex flex-col gap-1 items-start max-w-[190px] transform hover:scale-105 transition-transform duration-300 select-none">
        ...
        <section className="relative z-10 -mt-10 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Card 1 */}
            <div className="bg-white p-8 rounded-3xl shadow-md border border-brand-canvas flex flex-col justify-between hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              <div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 relative grid grid-cols-2 gap-4">
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-brand-navy text-white p-5 rounded-3xl shadow-2xl border-4 border-white text-center select-none">
        ...
        <section className="py-20 bg-white border-t border-brand-canvas">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Sector 1 */}
              <div className="bg-brand-canvas rounded-3xl p-6 border border-brand-slate/10 shadow-sm flex flex-col justify-between hover:shadow-lg transition-shadow">
                <div>
        ...
        {/* HIGH-CONTRAST DARK MISSION BANNER WITH OVERLAPPING CIRCULAR PORTRAIT (from both reference mockups) */}
        <section className="py-24 max-w-7xl mx-auto px-6">
        ...
        {/* SIDE-BY-SIDE CONTACT PREVIEW CARD (from Valley Best Care reference) */}
          ...
          <div className="bg-white rounded-[32px] p-8 md:p-12 border border-brand-canvas shadow-md grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-5 relative aspect-[4/3] rounded-3xl overflow-hidden shadow-md">
              ...
              <div className="absolute bottom-6 left-6 right-6 text-white">
                ...
                <p className="text-xs text-brand-canvas/80 mt-1">24/7 Coordinator Hotline: 020 7946 0192</p>
              </div>
            </div>
